...
# Paths
BASE_PATH="$SCRATCH/cross_dc/Megatron-LM/test_crossdc/helios/strong_scaling_gen"
...
JOB_LOG_PATH="${{BASE_PATH}}/job_logs/strong_{TB_size}_{PP}_{schedule}"
...
"""
            ...
            with open(f"strong_{TB_size}_{PP}_{schedule}_prof.sh", "w") as f:
                f.write('\n'.join([job_str, prof_str]))
            with open(f"strong_{TB_size}_{PP}_{schedule}_exec.sh", "w") as f:
