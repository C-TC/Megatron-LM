'''
from https://github.com/sail-sg/zero-bubble-pipeline-parallelism/blob/main/megatron/core/pipeline_parallel/v_schedule.py#L15
'''
...
class OfficialZBVHeuristicScheduler:
    ...
    def get_schedule(self) -> List[List[Tuple[int, int, int, str, int]]]:
        ...
        for dev in range(self.sys_cfg.num_devices):
            for node in adapt_schedule[dev]:
