...
class ScheduleDevice:
    def __init__(self, dev_id: int, sys_cfg: SystemConfig) -> None:
        ...
        self.scheduled_nodes: List[UDScheduleNode] = []

        self.schedulable_nodes: List[UDScheduleNode] = []
    ...
    def _next_to_schedule(self) -> Tuple[None | UDScheduleNode, int | float]:
        """
...
class ZBUDHeuristicSchedule:
    ...
    def _get_next_block(self, cur_node: UDScheduleNode):
